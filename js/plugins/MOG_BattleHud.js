...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_BattleHud');
	...
	Moghunter.bhud_max_battle_members = Number(Moghunter.parameters['Max Battle Members'] || 3);
	...
	Moghunter.bhud_turn_pos_x = Number(Moghunter.parameters['Turn X-Axis'] || -20);
	Moghunter.bhud_turn_pos_y = Number(Moghunter.parameters['Turn Y-Axis'] || 17);		
	...
	Moghunter.bhud_face_pos_y = Number(Moghunter.parameters['Face Y-Axis'] || 44);
	...
	Moghunter.bhud_name_pos_x = Number(Moghunter.parameters['Name X-Axis'] || 75);
	Moghunter.bhud_name_pos_y = Number(Moghunter.parameters['Name Y-Axis'] || 35);	
	...
	Moghunter.bhud_hp_meter_pos_y = Number(Moghunter.parameters['HP Meter Y-Axis'] || 40);
	...
	Moghunter.bhud_hp_number_pos_y  = Number(Moghunter.parameters['HP Number Y-Axis'] || 28);
    ...
    Moghunter.bhud_hp_align_type  = Number(Moghunter.parameters['HP Number Align type2'] || 0);	
	
	// MP METER POSITION
	Moghunter.bhud_mp_meter_visible = String(Moghunter.parameters['MP Meter Visible'] || "true");
	Moghunter.bhud_mp_meter_pos_x = Number(Moghunter.parameters['MP Meter X-Axis'] || 206);
	Moghunter.bhud_mp_meter_pos_y = Number(Moghunter.parameters['MP Meter Y-Axis'] || 40);	
	...
	Moghunter.bhud_mp_number_pos_x  = Number(Moghunter.parameters['MP Number X-Axis'] || 270);
	Moghunter.bhud_mp_number_pos_y  = Number(Moghunter.parameters['MP Number Y-Axis'] || 28);
	...
	// TP METER POSITION
	Moghunter.bhud_tp_meter_visible = String(Moghunter.parameters['TP Meter Visible'] || false);
	...
	// TP NUMBER POSITION
	Moghunter.bhud_tp_number_visible  = String(Moghunter.parameters['TP Number Visible'] || false);
	...
	Moghunter.bhud_at_meter_pos_x = Number(Moghunter.parameters['ATB Meter X-Axis'] || 160);
	Moghunter.bhud_at_meter_pos_y = Number(Moghunter.parameters['ATB Meter Y-Axis'] || 58);	
	...
	Moghunter.bhud_states_pos_x = Number(Moghunter.parameters['States X-Axis'] || 313);
	Moghunter.bhud_states_pos_y = Number(Moghunter.parameters['States Y-Axis'] || 28);	
    Moghunter.bhud_statesType = Number(Moghunter.parameters['States Mode'] || 1);	
    ...
    // COMMAND WINDOWS
	Moghunter.bhud_auto_pos = String(Moghunter.parameters['Command Auto Adjust2'] || "false");
    Moghunter.bhud_com_x = Number(Moghunter.parameters['W Command X-Axis'] || 20);
    Moghunter.bhud_com_y = Number(Moghunter.parameters['W Command Y-Axis'] || 420);
